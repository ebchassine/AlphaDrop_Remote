...
########################################################################################################
        ...
        if args.batch_chunk > 1:
            ...
            # ret = para_model(data, target, *mems, temps) # CHANGED HERE 
            inputs = list(mems) + [temps]
            ret = para_model(data, target, *inputs)
